<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Istatistik.aspx.cs" Inherits="DynamicCV.Istatistik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link href="web/css/style.css" rel="stylesheet" />
    <link href="web/css/jqvmap.css" rel="stylesheet" />
    <script src="web/js/Chart1.js"></script>
    <script src="web/js/jquery.min.js"></script>
    <script src="web/js/jquery.vmap.js"></script>
    <script src="web/js/jquery.vmap.sampledata.js"></script>
    <script src="web/js/jquery.vmap.world.js"></script>
    ...
    <div class="list_of_members">
        ...
        <div class="visitors">
            ...
            <div class="icon-text">
                <h3>
                    <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label>:<asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>
                </h3>
